...
const HeroSection = ({ user }: HeroSectionProps) => {
  ...
  return (
    <div className="relative md:mb-8 mb-6 max-w-6xl mx-auto">
        ...
        <div className="relative z-10 flex items-center">
          <div className="w-1/2 py-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/benefits"
                className="btn-sm btn-primary group hover:btn-outline-primary"
              >
                {t("ctaPrimary")}
              ...
              <Link
                href="/help-center"
                className="btn-sm btn-outline-secondary group/btn2"
              >
      ...
      <div className="md:hidden relative min-h-[60vh] -mx-6">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/illustrations/hero-banner-mobile.png')",
          }}
        >
        ...
        <div className="relative z-10 min-h-[60vh] flex items-center px-6">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              ...
              <Link
                href="/benefits"
                className="btn-sm btn-primary group w-full justify-center"
              >
              ...
              <Link
                href="/help-center"
                className="btn-sm btn-outline-secondary group w-full justify-center bg-white/10 backdrop-blur-sm hover:bg-white/20 border-white/30"
              >
