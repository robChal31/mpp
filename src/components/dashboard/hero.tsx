...
const Hero = () => {
  ...
  return (
    <div className="md:py-16 px-6 bg-white md:bg-transparent relative overflow-hidden">
        ...
        <div className="hidden md:flex flex-row items-center gap-12 relative">
          ...
          <div className="flex-1 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="btn-primary group hover:btn-outline-primary">
                {t('ctaPrimary')}
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="btn-outline-secondary group/btn2">
          ...
          <div className="relative z-10 min-h-[65vh] flex items-center px-6">
            <div className="w-full">
              ...
              <h1 className="text-xl font-bold text-white mb-2 drop-shadow-lg">
                {t('welcome')}, <span className="text-white">{t('userName')}</span>
              </h1>
              ...
              {/* Description */}
              <p className="text-white/90 text-sm max-w-lg leading-relaxed mb-8 drop-shadow-md">
                {t('description')}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button className="btn-white-outline group">
